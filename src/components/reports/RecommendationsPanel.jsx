...
export const RecommendationsPanel = ({ recommendations = [] }) => {
  const defaultRecommendations = [
    ...
    { id: 3, title: 'Improve Stability', description: 'Focus on core stability exercises to enhance balance', priority: 'high' },
    { id: 4, title: 'Focus on Flexibility', description: 'Add stretching routines to improve overall flexibility', priority: 'medium' },
  ];
